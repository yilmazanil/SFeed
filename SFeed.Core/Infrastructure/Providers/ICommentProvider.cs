...
namespace SFeed.Core.Infrastructure.Providers
{
    public interface ICommentProvider
    {
        ...
        /// <returns></returns>
        IEnumerable<CommentDetailedModel> GetComments(string postId, int skip, int size);
        /// <summary>
        /// Returns comments for a spesific post
        /// </summary>
        /// <param name="postId">Id of post</param>
        ...
        /// <param name="size">Number of comments to return</param>
        /// <returns></returns>
        IEnumerable<CommentDetailedModel> GetLatestComments(string postId);
        /// <summary>
        ...
        /// <param name="size">Number of comments to return</param>
        /// <returns></returns>
        IEnumerable<CommentDetailedModel> GetLatestCommentsCached(string postId);
        /// <summary>
        /// Returns a comment
        /// </summary>
        /// <param name="postId">Id of associated post</param>
        ...
        /// <param name="commentId">Id of comment</param>
        /// <returns></returns>
        CommentDetailedModel GetCommentDetailed(string postId, long commentId);
    }
}
